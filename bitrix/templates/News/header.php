...
<head>
    ...
    <meta charset="utf-8">
    <title><? $APPLICATION->ShowTitle() ?></title>        <!-- Спутник
		================================================== -->
    <meta
    ...
    <script type="text/javascript"> (function (d, w, c) {
            (w[c] = w[c] || []).push(function () {
                try {
                    w.yaCounter47268480 = new Ya.Metrika({
                        id: 47268480,
                        clickmap: true,
                        trackLinks: true,
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/47268480" style="position:absolute; left:-9999px;" alt=""/></div>
    ...
    <link href="<?=SITE_TEMPLATE_PATH?>/css/theme.css?ver=1.4" rel="stylesheet">
        ...
        <div class="container">
            <div class="row utility-menu">
                <div class="col-sm-12">
                    <div class="utility-inner clearfix">
                        ...
                        <span class="alt-font"><i class="icon icon_mail"></i><a href="mailto:maougimn40@edu.klgd.ru"
                                                                                style="text-decoration:none"
                                                                                class="text-white">maougimn40@edu.klgd.ru</a><a
                                    href="/Gym40_information/sitemap.php"> &#160;&#160;Карта сайта</a></span>
                        <div class="pull-right">
                            <a href="/search/index.php" class="btn btn-primary btn-white btn-xs">Поиск</a>
                            <a href="/bitrix/templates/main_page/session.php" id="special"
                               onclick="document.getElementById('target').submit(); return false;"
                               class="btn btn-primary btn-filled btn-xs">Версия для слабовидящих</a>
            ...
            <div class="row">
                <div class="col-md-12 hidden-sm hidden-xs columns">
                    <a href="/index.php">
                        <img class="centered_logo"
                             src="/bitrix/templates/<? echo SITE_TEMPLATE_ID; ?>/images/logo_new.png" height="120px"
                             width="120px">
                ...
                <div class="row nav-menu">
                    ...
                    <div class="col-sm-2 col-md-2 hidden-xs columns">
                        <ul class="social-icons text-right">
                            <li>
                                <a href="https://www.youtube.com/channel/UCVqcS05E_yaMXkKkGOLXNVg">
    ...
    <header class="page-header">
        <div class="background-image-holder parallax-background">
            <img class="background-image" alt="Background Image"
                 src="/bitrix/templates/<? echo SITE_TEMPLATE_ID; ?>/images/back_main.jpeg">
        </div>
