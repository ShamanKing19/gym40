...
<html class="no-js"> <!--<![endif]-->
	...
	<?$APPLICATION->ShowHead();?>
		...
		<link href="<?=SITE_TEMPLATE_PATH?>/css/theme.css?=ver1.6" rel="stylesheet">
			...
			<div class="container">
					...
					<div class="row utility-menu">
						<div class="col-sm-12">
							<div class="utility-inner clearfix">
								...
								<span class="alt-font"><i class="icon icon_mail"></i><a href="mailto:maougimn40@edu.klgd.ru" style="text-decoration:none" class="text-white"> maougimn40@edu.klgd.ru</a><a href="/Gym40_information/sitemap.php"> &#160;&#160;Карта сайта</a><a href="/Gym40_information/contacts/"> &#160;&#160;Контакты</a></span>
					...
					<div class="row">
                        <div class="col-md-12 hidden-sm hidden-xs columns">
							<a href="/index.php" >
                             <img class="centered_logo" src="/bitrix/templates/<? echo SITE_TEMPLATE_ID;?>/images/logo_new.png" height="120px" width="120px">
