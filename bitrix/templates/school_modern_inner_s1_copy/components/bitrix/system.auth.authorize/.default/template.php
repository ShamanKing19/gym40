...
<div>
<input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" /><label style="display:inline-block" for="USER_REMEMBER">&nbsp;<?=GetMessage("AUTH_REMEMBER_ME")?></label>
</div>
<?endif?>
<div>
	<button class="zayavka_btn" type="submit" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>"><?=GetMessage("AUTH_AUTHORIZE")?></button>
</div>

<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
		<noindex>
			<p>
				<br /><a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
			</p>
		</noindex>
<?endif?>
