...
<? 
$USER_ID = $USER->GetID();
if ($USER->IsAdmin()){ echo "<a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=60&filter_section=&IBLOCK_SECTION_ID=&return_url=%2Fbusiness%2Forders><b><font color=red>Добавить новую запись в раздел &laquo;Список ТСЖ&raquo;</font></b></a><br><br>";}
?>
	...
	<tr>
		<td bgcolor=#FFFFFF>
			...
			<form method=GET action=index.php>
				<tr>
					<td colspan="2"><strong>Фильтр ТСЖ:</strong></td>
				</tr>
				<tr>
					<td align="right" nowrap>Наименование ТСЖ:</td>
...
?>
	<table width="100%" cellpadding="0" cellspacing="0" border=0>
					...
					<td width=80% align=center style=font-size:10px>Наименование ТСЖ</td>
					</table></td></tr>
					...
					<tr>
						<td bgcolor=#FFFFFF>
							<table width=100% cellpadding=1 cellspacing=1 border=0 cols=2 class=tablehead>";
								if ($USER->IsAdmin()) {
								echo "<tr>
									<td colspan=2 bgcolor=#FFFFFF> Заказ № $arItem[ID], <a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=60&ID=$arItem[ID]&filter_section=&return_url=%2Fbusiness%2Forders>редактировать ТСЖ</a>, <a href=$delpage>удалить ТСЖ</a></td>
								</tr>";			}
								echo "<tr valign=top>
								<td bgcolor=#FFFFFF width=80%><a href=/city/gkh/tsg2014/detail.php?ID=$arItem[ID]><strong>$arItem[NAME]</strong></a><br>
