...
<form action="<? echo $APPLICATION->GetCurPage(); ?>" method="GET">
		...
		<td><select name="IDT" class="inputselect">
			...
			<option value="15" <? if ($IDT == 15) echo " selected"; ?>>Принятые Главой администрации района</option>
                        <option value="17" <? if ($IDT == 17) echo " selected"; ?>>Принятые Советом депутатов </option>
			...
			<option value="45" <? if ($IDT == 45) echo " selected"; ?>>Проекты документов МО "Гусевский муниципальный район"</option>
                        ...
                        <option value="16" <? if ($IDT == 16) echo " selected"; ?>>Права потребителей</option>
                        <option value="22" <? if ($IDT == 22) echo " selected"; ?>>Градостроительство, недвижимость и зем.ресурсы</option>
			<option value="23" <? if ($IDT == 23) echo " selected"; ?>>Муниципальный заказ</option>
