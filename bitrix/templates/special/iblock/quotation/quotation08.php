...
<? 
$USER_ID = $USER->GetID();
if ($USER->IsAdmin()){ echo "<a href=/bitrix/admin/iblock_element_edit.php?type=orders&lang=ru&IBLOCK_ID=13&filter_section=&IBLOCK_SECTION_ID=&return_url=%2Fbusiness%2Forders%2Fquotation><b><font color=red>Добавить новую запись в раздел &laquo;Котировки&raquo;</font></b></a><br><br>";}
?>
	...
	<tr>
		<td bgcolor=#FFFFFF>
			...
			<form method=GET action=index.php>
				...
				<tr>
					<td align="right" nowrap>Название котировки:</td>
...
<?
		...
		$items = GetIBlockElementList(13, false, Array("DATE_CREATE"=>"DESC", "ID"=>"DESC", "NAME"=>"DESC"), 25, $arrFilter);
...
?>
	<table width="100%" cellpadding="0" cellspacing="0" border=0>
				<tr ><td width=100%>
					...
					<td width=14% align=center style=font-size:10px>Дата <br> назначения:</td>
					<td width=14% align=center style=font-size:10px>Дата <br>завершения:</td>
		...
		while($arItem = $items->GetNext())
		{
			...
			$date1 = $arIBlockElement['PROPERTIES']['date1']['VALUE'];
			$date2 = $arIBlockElement['PROPERTIES']['date2']['VALUE'];
						...
						<td bgcolor=#FFFFFF>
							<table width=100% cellpadding=1 cellspacing=1 border=0 cols=4 class=tablehead>";
								...
								echo "<tr>
									...
									<a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=13&ID=$arItem[ID]&filter_section=&return_url=%2Fbusiness%2Forders%2Fquotation>редактировать котировку</a>, <a href=$delpage>удалить котировку</a></td>
									</tr>";}
								echo "<tr valign=top>
										<td bgcolor=#FFFFFF width=60% align=left><strong>$arItem[ACTIVE_FROM]</strong> <a href=/orders/arhiv/quotation/detail.php?ID=$arItem[ID]><strong>$arItem[NAME]</strong></a><br>
