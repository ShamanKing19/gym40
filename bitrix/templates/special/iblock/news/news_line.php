...
if(CModule::IncludeModule("iblock")):
	if($cache->StartDataCache($CACHE_TIME, $CACHE_ID)):
		$items = GetIBlockElementListEx($IBLOCK_TYPE, $IBLOCK, Array(), $SORT, Array("nTopCount"=>$NEWS_COUNT));
		if($arItem = $items->GetNext()):
		?>
		<table border="0" cellspacing="0" cellpadding="2" id="mainTable">
			<?do{?>
			<tr>
				<td valign="top"><font class="newsdate"><?echo $arItem["ACTIVE_FROM"]?></font></td><td width="100%"><a href="<?echo $arItem["DETAIL_PAGE_URL"]?>&special=y"><?echo $arItem["NAME"]?></a></td>
			</tr>
