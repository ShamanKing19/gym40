				...
				<?while($obItem = $items->GetNextElement()):?>
					<tr>
						<td width="100%">
							...
							?>
							<font class="newsdate"><?echo $arItem["ACTIVE_FROM"]?></font><?
								if (strlen($arItem["ACTIVE_FROM"])>0):?>&nbsp;|&nbsp;<?endif;?>
								<font class="text">
								<?if ($arItem["DETAIL_TEXT"] && !$arLinkProp["VALUE"]):?><a href="<?echo $arItem["DETAIL_PAGE_URL"]."&special=y"?>"><?elseif ($arLinkProp["VALUE"]):?><a href="<?echo $arLinkProp["VALUE"]?>"><?endif;?><?=$arItem["NAME"]?><?if ($arItem["DETAIL_TEXT"] || $arLinkProp["VALUE"]):?></a><?endif;?>
								</font>
							<br>
						</td>
					</tr>
					...
					<td valign="top" width="100%">
						...
						<table cellpadding="0" cellspacing="0" border="0" align="left">
							<tr>
							<td valign="top"><?echo ShowImage($arItem["PREVIEW_PICTURE"], 100, 100, "hspace='2' vspace='2' align='left' border='0'", $arItem["DETAIL_PAGE_URL"]."&special=y");?></td>
