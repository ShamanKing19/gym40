				...
				<tr>
					<td>
						<?  if(strlen($arIBlockElement["PROPERTIES"]["docfile1"]["VALUE"])>0 OR strlen($arIBlockElement["PROPERTIES"]["docfile2"]["VALUE"])>0 OR strlen($arIBlockElement["PROPERTIES"]["docfile3"]["VALUE"])>0 OR strlen($arIBlockElement["PROPERTIES"]["docfile4"]["VALUE"])>0 OR strlen($arIBlockElement["PROPERTIES"]["docfile5"]["VALUE"])>0    OR strlen($arIBlockElement["PROPERTIES"]["docfile6"]["VALUE"])>0) :echo "<hr><font class=smalltext><strong>Список прилагаемых документов:</strong></font><br><br>"; ?>
							...
							<?  if(strlen($arIBlockElement["PROPERTIES"]["docfile2"]["VALUE"])>0): $DOCFILE2 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile2"]["VALUE"]);$date2 = $arIBlockElement['PROPERTIES']['date2']['VALUE'];echo "<tr><td><a href=$DOCFILE2><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Документы</a></td><td>$date2</td></tr>";?><?endif?>			
							<?  if(strlen($arIBlockElement["PROPERTIES"]["docfile3"]["VALUE"])>0): $DOCFILE3 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile3"]["VALUE"]);$date3 = $arIBlockElement['PROPERTIES']['date3']['VALUE'];echo "<tr><td><a href=$DOCFILE3><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Фотографии</a></td><td>$date3</td></tr>";?><?endif?>			
							<?  if(strlen($arIBlockElement["PROPERTIES"]["docfile4"]["VALUE"])>0): $DOCFILE4 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile4"]["VALUE"]);$date4 = $arIBlockElement['PROPERTIES']['date4']['VALUE'];echo "<tr><td><a href=$DOCFILE4><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Приложение 1</a></td><td>$date4</td></tr>";?><?endif?>			
                                                        <?  if(strlen($arIBlockElement["PROPERTIES"]["docfile5"]["VALUE"])>0): $DOCFILE5 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile5"]["VALUE"]);$date5 = $arIBlockElement['PROPERTIES']['date5']['VALUE'];echo "<tr><td><a href=$DOCFILE5><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Приложение 2</a></td><td>$date5</td></tr>";?><?endif?>
							<?  if(strlen($arIBlockElement["PROPERTIES"]["docfile6"]["VALUE"])>0): $DOCFILE6 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile6"]["VALUE"]);$date6 = $arIBlockElement['PROPERTIES']['date6']['VALUE'];echo "<tr><td><a href=$DOCFILE6><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Изменения</a></td><td>$date6</td></tr>";?><?endif?>
                                                        ...
                                                        <?  if(strlen($arIBlockElement["PROPERTIES"]["docfile8"]["VALUE"])>0): $DOCFILE8 = CFile::GetPath($arIBlockElement["PROPERTIES"]["docfile8"]["VALUE"]);$date8 = $arIBlockElement['PROPERTIES']['date8']['VALUE'];echo "<tr><td><a href=$DOCFILE8><img src=/images/download.gif width=14 height=14 border=0 alt=\"Загрузить документ\" hspace=3 align=absmiddle>Итоги</a></td><td>$date8</td></tr>";?><?endif?>
                                                         </tbody>
                                                        </table>
