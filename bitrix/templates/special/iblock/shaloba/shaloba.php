...
<? 
$USER_ID = $USER->GetID();
if ($USER->IsAdmin()){ echo "<a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=33&filter_section=&IBLOCK_SECTION_ID=&return_url=%2Fbusiness%2Forders><b><font color=red>Добавить новую запись в раздел &laquo;жалобы&raquo;</font></b></a><br><br>";}
?>
	...
	<tr>
		<td bgcolor=#FFFFFF>
			...
			<form method=GET action=index.php>
				<tr>
					<td colspan="2"><strong>Фильтр жалоб:</strong></td>
				</tr>
				<tr>
					<td align="right" nowrap>Название жалобы:</td>
...
?>
	<table width="100%" cellpadding="0" cellspacing="0" border=0>
					...
					<td width=80% align=center style=font-size:10px>Краткое наименование</td>
                                      	<td width=20% align=center style=font-size:10px>Дата поступления</td>
					</table></td></tr>
					...
					<tr>
						<td bgcolor=#FFFFFF>
							<table width=100% cellpadding=1 cellspacing=1 border=0 cols=2 class=tablehead>";
								...
								echo "<tr valign=top>
								<td bgcolor=#FFFFFF width=80%><a href=/orders/shaloba/detail.php?ID=$arItem[ID]><strong>$arItem[NAME]</strong></a><br>
