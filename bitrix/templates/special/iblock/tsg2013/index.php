...
<? 
$USER_ID = $USER->GetID();
if ($USER->IsAdmin()){ echo "<a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=59&filter_section=&IBLOCK_SECTION_ID=&return_url=%2Fbusiness%2Forders><b><font color=red>Добавить новую запись в раздел &laquo;Список ТСЖ&raquo;</font></b></a><br><br>";}
?>
					...
					<tr>
						<td bgcolor=#FFFFFF>
							<table width=100% cellpadding=1 cellspacing=1 border=0 cols=2 class=tablehead>";
								if ($USER->IsAdmin()) {
								echo "<tr>
									<td colspan=2 bgcolor=#FFFFFF> Заказ № $arItem[ID], <a href=/bitrix/admin/iblock_element_edit.php?type=news&lang=ru&IBLOCK_ID=59&ID=$arItem[ID]&filter_section=&return_url=%2Fbusiness%2Forders>редактировать ТСЖ</a>, <a href=$delpage>удалить ТСЖ</a></td>
								</tr>";			}
								echo "<tr valign=top>
								<td bgcolor=#FFFFFF width=80%><a href=/city/gkh/tsg2013/detail.php?ID=$arItem[ID]><strong>$arItem[NAME]</strong></a><br>
