...
if (CModule::IncludeModule("iblock")):
	...
	*************************************************************************/
	...
	if($obCache->StartDataCache($CACHE_TIME, $CACHE_ID, "/")):
		...
		************************************/
		...
		while ($arSection = $rsSections->Fetch()) :
			...
			************************************/
			...
			if ($rsElements = GetIBlockElementListEx($IBLOCK_TYPE, false, false, array($ELEMENT_SORT_FIELD => $ELEMENT_SORT_ORDER, "ID" => "ASC"), $ELEMENT_COUNT, $arrFilter, $arSelect)):
		...
		****************************************************************/
		?>
		<a class="subtitletext" href="<?=$SECTION_URL?>&SECTION_ID=<?=$arSection["ID"]?>">Рубрика &laquo;<?echo htmlspecialchars($arSection["NAME"])?>&raquo;</a><br><img height="10" src="/bitrix/images/1.gif" width="1"><br>
