	...
	*************************************************************************/
	...
	if (intval($SECTION_ID)>0) : 
		...
		<?if ($count>0):?><p><?echo $rsElements->NavPrint($ELEMENT_NAME)?></p><?endif;?>
			...
			<? if ($SubGroup = GetIBlockSectionList($IBLOCK_ID, $_GET[SECTION_ID], array($ELEMENT_SORT_FIELD => $ELEMENT_SORT_ORDER, "ID" => "ASC"))):
				$SubCount = intval($SubGroup->SelectedRowsCount());
				if ($SubCount>0):?>
					<table cellpadding="5" cellspacing="0" border="0 width="100%" align="center">	
						<tr>
							<td height="25" valign="top" colspan="2"><strong>Альбомы:</strong></td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						</tr>
						<tr>
							<td colspan="2"><?$SubGroup->NavStart("20"); $SubGroup->NavPrint("Альбомов показано: ");?></td>
						</tr>
						<? while($SubItem = $SubGroup->GetNext()) { ?> <tr valign="top"><td><a href=/press/gallery/gallery.php?&SECTION_ID=<?echo $SubItem["ID"];?>><? echo ShowImage($SubItem["PICTURE"], 100, 100, "hspace='5' vspace=5' align='left' border='0'");?></a></td><td width="100%"><a href=/press/gallery/gallery.php?&SECTION_ID=<?echo $SubItem["ID"];?>><?echo $SubItem["NAME"];?></a></td></tr> <?} ?>
						<tr>
							<td colspan="2"><hr></td>
						</tr>	
						<tr>
			...
			<tr align="center">
				...
				<td valign="top" width="<?=(100/$LINE_ELEMENT_COUNT)?>%">
					<table cellpadding="2" cellspacing="0" border="0" align="center">
						<tr>
							<td valign="top" align="center"><?echo CFile::Show2Images($image1, $image2, 150, 150, "hspace='0' vspace='0' border='0' title='".$arElement["NAME"]."'", true);?></td>
						</tr>
						<tr>
							<td valign="top" align="center"><font class="text"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a></font></td>
						</tr>
					</table></td>
					<?
