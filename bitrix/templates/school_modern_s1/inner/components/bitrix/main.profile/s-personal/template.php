...
<table class="data-table profile-table">
	...
	<p><button class="zayavka_btn" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>"><?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?></button>&nbsp;&nbsp;<button class="zayavka_btn" type="reset" value="<?=GetMessage('MAIN_RESET');?>"><?=GetMessage('MAIN_RESET');?></button></p>
</form>
