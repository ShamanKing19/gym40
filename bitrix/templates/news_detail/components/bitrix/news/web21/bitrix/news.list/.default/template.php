...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
<div class="col-md-3 col-sm-6 blog-masonry-item branding" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
...
<div class="post-meta">
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<span class="sub alt-font"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?></span>
		<?endif?>
</div>
		<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
