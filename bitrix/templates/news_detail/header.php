...
<html class="no-js"> <!--<![endif]-->
	...
	<?$APPLICATION->ShowHead();?>
        ...
        <link href="<?=SITE_TEMPLATE_PATH?>/css/theme.css?ver=1.9" rel="stylesheet">
			...
			<div class="container">
					...
					<div class="row">
                        <div class="col-md-12 hidden-sm hidden-xs columns">
							<a href="/index.php"> <img src="/bitrix/templates/main_page/images/logo_new.png" class="centered_logo" height="120px" width="120px"> 
						...
						<div class="row nav-menu">
							...
							<div class="col-sm-2 col-md-2 hidden-xs columns">
								<ul class="social-icons text-right">
									<li>
										<a href="https://youtu.be/BnrUBP1WVtg">
